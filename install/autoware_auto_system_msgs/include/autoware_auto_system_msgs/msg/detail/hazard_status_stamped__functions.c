...
autoware_auto_system_msgs__msg__HazardStatusStamped__create()
{
  ...
  autoware_auto_system_msgs__msg__HazardStatusStamped * msg = (autoware_auto_system_msgs__msg__HazardStatusStamped *)allocator.allocate(sizeof(autoware_auto_system_msgs__msg__HazardStatusStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence__init(autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_system_msgs__msg__HazardStatusStamped *)allocator.zero_allocate(size, sizeof(autoware_auto_system_msgs__msg__HazardStatusStamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence * array = (autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence *)allocator.allocate(sizeof(autoware_auto_system_msgs__msg__HazardStatusStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
