...
#include <stddef.h>
#include "autoware_vehicle_msgs/msg/detail/vehicle_control_command__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_vehicle_msgs__msg__VehicleControlCommand__init(message_memory);
}

void VehicleControlCommand__rosidl_typesupport_introspection_c__VehicleControlCommand_fini_function(void * message_memory)
{
  autoware_vehicle_msgs__msg__VehicleControlCommand__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleControlCommand__rosidl_typesupport_introspection_c__VehicleControlCommand_message_member_array[5] = {
  {
    ...
    offsetof(autoware_vehicle_msgs__msg__VehicleControlCommand, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__VehicleControlCommand, long_accel_mps2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__VehicleControlCommand, velocity_mps),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__VehicleControlCommand, front_wheel_angle_rad),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs__msg__VehicleControlCommand, rear_wheel_angle_rad),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleControlCommand__rosidl_typesupport_introspection_c__VehicleControlCommand_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_vehicle_msgs__msg__VehicleControlCommand),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_vehicle_msgs, msg, VehicleControlCommand)() {
