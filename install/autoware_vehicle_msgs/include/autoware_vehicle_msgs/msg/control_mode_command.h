...
#ifndef AUTOWARE_VEHICLE_MSGS__MSG__CONTROL_MODE_COMMAND_H_
#define AUTOWARE_VEHICLE_MSGS__MSG__CONTROL_MODE_COMMAND_H_
...
#endif  // AUTOWARE_VEHICLE_MSGS__MSG__CONTROL_MODE_COMMAND_H_
