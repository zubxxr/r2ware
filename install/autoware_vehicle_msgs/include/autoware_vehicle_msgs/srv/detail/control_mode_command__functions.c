  ...
  autoware_vehicle_msgs__srv__ControlModeCommand_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_vehicle_msgs__srv__ControlModeCommand_Request * data =
      (autoware_vehicle_msgs__srv__ControlModeCommand_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_vehicle_msgs__srv__ControlModeCommand_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_vehicle_msgs__srv__ControlModeCommand_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  autoware_vehicle_msgs__srv__ControlModeCommand_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_vehicle_msgs__srv__ControlModeCommand_Response * data =
      (autoware_vehicle_msgs__srv__ControlModeCommand_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_vehicle_msgs__srv__ControlModeCommand_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          autoware_vehicle_msgs__srv__ControlModeCommand_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
