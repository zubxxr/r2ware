...
{
  new (message_memory) autoware_adapi_v1_msgs::msg::Gear(_init);
}

void Gear_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_adapi_v1_msgs::msg::Gear *>(message_memory);
  typed_message->~Gear();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Gear_message_member_array[1] = {
  {
    ...
    offsetof(autoware_adapi_v1_msgs::msg::Gear, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Gear_message_members = {
  ...
  "Gear",  // message name
  1,  // number of fields
  sizeof(autoware_adapi_v1_msgs::msg::Gear),
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::Gear_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, Gear)() {
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::Gear_message_type_support_handle;
}
