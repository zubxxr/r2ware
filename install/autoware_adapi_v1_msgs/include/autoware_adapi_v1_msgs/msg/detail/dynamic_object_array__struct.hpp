...
struct DynamicObjectArray_
{
  ...
  _header_type header;
  using _objects_type =
    std::vector<autoware_adapi_v1_msgs::msg::DynamicObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::DynamicObject_<ContainerAllocator>>::other>;
  ...
  Type & set__objects(
    const std::vector<autoware_adapi_v1_msgs::msg::DynamicObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::DynamicObject_<ContainerAllocator>>::other> & _arg)
  {
    this->objects = _arg;
    return *this;
  }
