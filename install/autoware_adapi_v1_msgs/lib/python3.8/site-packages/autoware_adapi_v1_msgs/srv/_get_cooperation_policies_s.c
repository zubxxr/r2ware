...
bool autoware_adapi_v1_msgs__srv__get_cooperation_policies__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.srv._get_cooperation_policies.GetCooperationPolicies_Request", full_classname_dest, 83) == 0);
  }
  autoware_adapi_v1_msgs__srv__GetCooperationPolicies_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of GetCooperationPolicies_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.srv._get_cooperation_policies");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetCooperationPolicies_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool autoware_adapi_v1_msgs__srv__get_cooperation_policies__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.srv._get_cooperation_policies.GetCooperationPolicies_Response", full_classname_dest, 84) == 0);
  }
  autoware_adapi_v1_msgs__srv__GetCooperationPolicies_Response * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of GetCooperationPolicies_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.srv._get_cooperation_policies");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetCooperationPolicies_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
