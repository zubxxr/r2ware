...
bool autoware_adapi_v1_msgs__msg__object_classification__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool autoware_adapi_v1_msgs__msg__dynamic_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._dynamic_object.DynamicObject", full_classname_dest, 56) == 0);
  }
  autoware_adapi_v1_msgs__msg__DynamicObject * ros_message = _ros_message;
  {  // id
  ...
  {  // classification
    ...
    if (!autoware_adapi_v1_msgs__msg__ObjectClassification__Sequence__init(&(ros_message->classification), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create autoware_adapi_v1_msgs__msg__ObjectClassification__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    autoware_adapi_v1_msgs__msg__ObjectClassification * dest = ros_message->classification.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__object_classification__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // kinematics
    ...
    if (!autoware_adapi_v1_msgs__msg__dynamic_object_kinematics__convert_from_py(field, &ros_message->kinematics)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_adapi_v1_msgs__msg__dynamic_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._dynamic_object");
  ...
  {  // classification
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = autoware_adapi_v1_msgs__msg__object_classification__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // kinematics
    PyObject * field = NULL;
    field = autoware_adapi_v1_msgs__msg__dynamic_object_kinematics__convert_to_py(&ros_message->kinematics);
    if (!field) {
      return NULL;
    }
    {
