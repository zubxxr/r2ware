...
bool autoware_adapi_v1_msgs__msg__cooperation_policy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._cooperation_policy.CooperationPolicy", full_classname_dest, 64) == 0);
  }
  autoware_adapi_v1_msgs__msg__CooperationPolicy * ros_message = _ros_message;
  {  // behavior
  ...
  {  // policy
    ...
    ros_message->policy = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of CooperationPolicy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._cooperation_policy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CooperationPolicy");
  ...
  {  // policy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->policy);
    {
