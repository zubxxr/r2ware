...
bool autoware_perception_msgs__msg__predicted_object_kinematics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // predicted_paths
    ...
    if (!autoware_perception_msgs__msg__PredictedPath__Sequence__init(&(ros_message->predicted_paths), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create autoware_perception_msgs__msg__PredictedPath__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    autoware_perception_msgs__msg__PredictedPath * dest = ros_message->predicted_paths.data;
