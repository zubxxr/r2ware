...
struct TrafficSignalArray_
{
  ...
  _stamp_type stamp;
  using _signals_type =
    std::vector<autoware_perception_msgs::msg::TrafficSignal_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_perception_msgs::msg::TrafficSignal_<ContainerAllocator>>::other>;
  ...
  Type & set__signals(
    const std::vector<autoware_perception_msgs::msg::TrafficSignal_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_perception_msgs::msg::TrafficSignal_<ContainerAllocator>>::other> & _arg)
  {
    this->signals = _arg;
    return *this;
  }
