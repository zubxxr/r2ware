...
#ifndef TIER4_CONTROL_MSGS__SRV__DETAIL__SET_STOP__FUNCTIONS_H_
#define TIER4_CONTROL_MSGS__SRV__DETAIL__SET_STOP__FUNCTIONS_H_
...
/// Initialize srv/SetStop message.
/**
...
/// Create srv/SetStop message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_control_msgs__srv__SetStop_Request__init().
...
/// Destroy srv/SetStop message.
/**
 * It calls
 * tier4_control_msgs__srv__SetStop_Request__fini()
...
/// Check for srv/SetStop message equality.
/**
...
/// Initialize array of srv/SetStop messages.
/**
...
/// Finalize array of srv/SetStop messages.
/**
 * It calls
 * tier4_control_msgs__srv__SetStop_Request__fini()
...
/// Create array of srv/SetStop messages.
/**
 * It allocates the memory for the array and calls
 * tier4_control_msgs__srv__SetStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetStop messages.
/**
 * It calls
 * tier4_control_msgs__srv__SetStop_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetStop message array equality.
/**
...
/// Copy an array of srv/SetStop messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_control_msgs__srv__SetStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_control_msgs
...
/**
 * It calls
 * tier4_control_msgs__srv__SetStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_control_msgs__srv__SetStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_control_msgs
...
/**
 * It calls
 * tier4_control_msgs__srv__SetStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_CONTROL_MSGS__SRV__DETAIL__SET_STOP__FUNCTIONS_H_
