...
autoware_auto_vehicle_msgs__msg__HazardLightsReport__create()
{
  ...
  autoware_auto_vehicle_msgs__msg__HazardLightsReport * msg = (autoware_auto_vehicle_msgs__msg__HazardLightsReport *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__HazardLightsReport), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__HazardLightsReport__Sequence__init(autoware_auto_vehicle_msgs__msg__HazardLightsReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__HazardLightsReport *)allocator.zero_allocate(size, sizeof(autoware_auto_vehicle_msgs__msg__HazardLightsReport), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_vehicle_msgs__msg__HazardLightsReport__Sequence * array = (autoware_auto_vehicle_msgs__msg__HazardLightsReport__Sequence *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__HazardLightsReport__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
