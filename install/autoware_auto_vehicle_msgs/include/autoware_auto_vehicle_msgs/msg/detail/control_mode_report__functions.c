...
autoware_auto_vehicle_msgs__msg__ControlModeReport__create()
{
  ...
  autoware_auto_vehicle_msgs__msg__ControlModeReport * msg = (autoware_auto_vehicle_msgs__msg__ControlModeReport *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__ControlModeReport), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__ControlModeReport__Sequence__init(autoware_auto_vehicle_msgs__msg__ControlModeReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__ControlModeReport *)allocator.zero_allocate(size, sizeof(autoware_auto_vehicle_msgs__msg__ControlModeReport), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_vehicle_msgs__msg__ControlModeReport__Sequence * array = (autoware_auto_vehicle_msgs__msg__ControlModeReport__Sequence *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__ControlModeReport__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
