...
bool autoware_planning_msgs__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_planning_msgs.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 60) == 0);
  }
  autoware_planning_msgs__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // time_from_start
...
PyObject * autoware_planning_msgs__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_planning_msgs.msg._trajectory_point");
