...
struct TrafficSignal_
{
  ...
  using _lights_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::TrafficLight_<ContainerAllocator>, 10, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrafficLight_<ContainerAllocator>>::other>;
  _lights_type lights;
  ...
  Type & set__lights(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::TrafficLight_<ContainerAllocator>, 10, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrafficLight_<ContainerAllocator>>::other> & _arg)
  {
    this->lights = _arg;
    return *this;
  }
