...
autoware_auto_perception_msgs__msg__DetectedObject__create()
{
  ...
  autoware_auto_perception_msgs__msg__DetectedObject * msg = (autoware_auto_perception_msgs__msg__DetectedObject *)allocator.allocate(sizeof(autoware_auto_perception_msgs__msg__DetectedObject), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__DetectedObject__Sequence__init(autoware_auto_perception_msgs__msg__DetectedObject__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__DetectedObject *)allocator.zero_allocate(size, sizeof(autoware_auto_perception_msgs__msg__DetectedObject), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_perception_msgs__msg__DetectedObject__Sequence * array = (autoware_auto_perception_msgs__msg__DetectedObject__Sequence *)allocator.allocate(sizeof(autoware_auto_perception_msgs__msg__DetectedObject__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
