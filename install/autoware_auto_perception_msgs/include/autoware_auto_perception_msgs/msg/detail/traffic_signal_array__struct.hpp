...
struct TrafficSignalArray_
{
  ...
  _header_type header;
  using _signals_type =
    std::vector<autoware_auto_perception_msgs::msg::TrafficSignal_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrafficSignal_<ContainerAllocator>>::other>;
  ...
  Type & set__signals(
    const std::vector<autoware_auto_perception_msgs::msg::TrafficSignal_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrafficSignal_<ContainerAllocator>>::other> & _arg)
  {
    this->signals = _arg;
    return *this;
  }
