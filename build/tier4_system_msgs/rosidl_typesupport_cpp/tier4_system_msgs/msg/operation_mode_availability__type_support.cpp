...
static const _OperationModeAvailability_type_support_symbol_names_t _OperationModeAvailability_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_system_msgs, msg, OperationModeAvailability)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_system_msgs, msg, OperationModeAvailability)),
  }
};
...
{
  return &::tier4_system_msgs::msg::rosidl_typesupport_cpp::OperationModeAvailability_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_system_msgs, msg, OperationModeAvailability)() {
  return get_message_type_support_handle<tier4_system_msgs::msg::OperationModeAvailability>();
}
