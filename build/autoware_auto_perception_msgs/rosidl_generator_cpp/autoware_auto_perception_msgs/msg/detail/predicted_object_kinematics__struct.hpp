...
struct PredictedObjectKinematics_
{
  ...
  using _predicted_paths_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>>::other>;
  ...
  Type & set__predicted_paths(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>>::other> & _arg)
  {
