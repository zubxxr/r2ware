...
bool autoware_perception_msgs__msg__shape__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_perception_msgs.msg._shape.Shape", full_classname_dest, 41) == 0);
  }
  autoware_perception_msgs__msg__Shape * ros_message = _ros_message;
  {  // type
...
PyObject * autoware_perception_msgs__msg__shape__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_perception_msgs.msg._shape");
