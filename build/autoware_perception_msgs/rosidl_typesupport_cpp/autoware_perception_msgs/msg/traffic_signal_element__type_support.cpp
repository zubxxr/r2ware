...
static const _TrafficSignalElement_type_support_symbol_names_t _TrafficSignalElement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, TrafficSignalElement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, TrafficSignalElement)),
  }
};
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_cpp::TrafficSignalElement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_perception_msgs, msg, TrafficSignalElement)() {
  return get_message_type_support_handle<autoware_perception_msgs::msg::TrafficSignalElement>();
}
