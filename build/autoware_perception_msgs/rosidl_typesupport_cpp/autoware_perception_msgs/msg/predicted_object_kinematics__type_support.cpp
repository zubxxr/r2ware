...
static const _PredictedObjectKinematics_type_support_symbol_names_t _PredictedObjectKinematics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_perception_msgs, msg, PredictedObjectKinematics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_perception_msgs, msg, PredictedObjectKinematics)),
  }
};
...
{
  return &::autoware_perception_msgs::msg::rosidl_typesupport_cpp::PredictedObjectKinematics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_perception_msgs, msg, PredictedObjectKinematics)() {
  return get_message_type_support_handle<autoware_perception_msgs::msg::PredictedObjectKinematics>();
}
