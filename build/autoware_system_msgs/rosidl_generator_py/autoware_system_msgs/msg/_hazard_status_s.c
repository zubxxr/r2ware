...
bool autoware_system_msgs__msg__hazard_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_system_msgs.msg._hazard_status.HazardStatus", full_classname_dest, 52) == 0);
  }
  autoware_system_msgs__msg__HazardStatus * ros_message = _ros_message;
  {  // level
...
PyObject * autoware_system_msgs__msg__hazard_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_system_msgs.msg._hazard_status");
