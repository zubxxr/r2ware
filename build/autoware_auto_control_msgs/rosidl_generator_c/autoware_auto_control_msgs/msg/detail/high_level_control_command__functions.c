...
autoware_auto_control_msgs__msg__HighLevelControlCommand__create()
{
  ...
  autoware_auto_control_msgs__msg__HighLevelControlCommand * msg = (autoware_auto_control_msgs__msg__HighLevelControlCommand *)allocator.allocate(sizeof(autoware_auto_control_msgs__msg__HighLevelControlCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_control_msgs__msg__HighLevelControlCommand__Sequence__init(autoware_auto_control_msgs__msg__HighLevelControlCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_control_msgs__msg__HighLevelControlCommand *)allocator.zero_allocate(size, sizeof(autoware_auto_control_msgs__msg__HighLevelControlCommand), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_control_msgs__msg__HighLevelControlCommand__Sequence * array = (autoware_auto_control_msgs__msg__HighLevelControlCommand__Sequence *)allocator.allocate(sizeof(autoware_auto_control_msgs__msg__HighLevelControlCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
