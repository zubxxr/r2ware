...
struct Route_
{
  ...
  using _route_sections_type =
    std::vector<tier4_external_api_msgs::msg::RouteSection_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::RouteSection_<ContainerAllocator>>::other>;
  ...
  Type & set__route_sections(
    const std::vector<tier4_external_api_msgs::msg::RouteSection_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::RouteSection_<ContainerAllocator>>::other> & _arg)
  {
