...
struct CalibrationStatusArray_
{
  ...
  using _status_array_type =
    std::vector<tier4_external_api_msgs::msg::CalibrationStatus_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::CalibrationStatus_<ContainerAllocator>>::other>;
  ...
  Type & set__status_array(
    const std::vector<tier4_external_api_msgs::msg::CalibrationStatus_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::CalibrationStatus_<ContainerAllocator>>::other> & _arg)
  {
