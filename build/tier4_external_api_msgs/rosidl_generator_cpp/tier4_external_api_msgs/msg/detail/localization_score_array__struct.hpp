...
struct LocalizationScoreArray_
{
  ...
  using _values_type =
    std::vector<tier4_external_api_msgs::msg::LocalizationScore_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::LocalizationScore_<ContainerAllocator>>::other>;
  _values_type values;

  // setters for named parameter idiom
  Type & set__values(
    const std::vector<tier4_external_api_msgs::msg::LocalizationScore_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_external_api_msgs::msg::LocalizationScore_<ContainerAllocator>>::other> & _arg)
  {
    this->values = _arg;
    return *this;
  }
