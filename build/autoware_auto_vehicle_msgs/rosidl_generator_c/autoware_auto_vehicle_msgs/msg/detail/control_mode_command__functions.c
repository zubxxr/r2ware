...
autoware_auto_vehicle_msgs__msg__ControlModeCommand__create()
{
  ...
  autoware_auto_vehicle_msgs__msg__ControlModeCommand * msg = (autoware_auto_vehicle_msgs__msg__ControlModeCommand *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__ControlModeCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__ControlModeCommand__Sequence__init(autoware_auto_vehicle_msgs__msg__ControlModeCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__ControlModeCommand *)allocator.zero_allocate(size, sizeof(autoware_auto_vehicle_msgs__msg__ControlModeCommand), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_vehicle_msgs__msg__ControlModeCommand__Sequence * array = (autoware_auto_vehicle_msgs__msg__ControlModeCommand__Sequence *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__ControlModeCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
