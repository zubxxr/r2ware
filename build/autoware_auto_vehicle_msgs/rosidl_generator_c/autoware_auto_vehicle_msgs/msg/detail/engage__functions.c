...
autoware_auto_vehicle_msgs__msg__Engage__create()
{
  ...
  autoware_auto_vehicle_msgs__msg__Engage * msg = (autoware_auto_vehicle_msgs__msg__Engage *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__Engage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__Engage__Sequence__init(autoware_auto_vehicle_msgs__msg__Engage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__Engage *)allocator.zero_allocate(size, sizeof(autoware_auto_vehicle_msgs__msg__Engage), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_vehicle_msgs__msg__Engage__Sequence * array = (autoware_auto_vehicle_msgs__msg__Engage__Sequence *)allocator.allocate(sizeof(autoware_auto_vehicle_msgs__msg__Engage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
