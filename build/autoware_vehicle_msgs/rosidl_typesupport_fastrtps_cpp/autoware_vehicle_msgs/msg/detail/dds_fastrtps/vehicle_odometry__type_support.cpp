...
#include "autoware_vehicle_msgs/msg/detail/vehicle_odometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_vehicle_msgs::msg::VehicleOdometry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_vehicle_msgs::msg::VehicleOdometry & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const autoware_vehicle_msgs::msg::VehicleOdometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_vehicle_msgs::msg::VehicleOdometry *>(
    untyped_ros_message);
...
{
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleOdometry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, VehicleOdometry)() {
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleOdometry__handle;
}
