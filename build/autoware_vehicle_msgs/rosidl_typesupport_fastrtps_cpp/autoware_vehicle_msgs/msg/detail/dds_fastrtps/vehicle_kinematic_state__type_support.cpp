...
#include "autoware_vehicle_msgs/msg/detail/vehicle_kinematic_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_vehicle_msgs::msg::VehicleKinematicState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_vehicle_msgs::msg::VehicleKinematicState & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const autoware_vehicle_msgs::msg::VehicleKinematicState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_vehicle_msgs::msg::VehicleKinematicState *>(
    untyped_ros_message);
...
{
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleKinematicState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, VehicleKinematicState)() {
  return &autoware_vehicle_msgs::msg::typesupport_fastrtps_cpp::_VehicleKinematicState__handle;
}
