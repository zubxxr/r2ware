...
bool autoware_vehicle_msgs__msg__vehicle_odometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_vehicle_msgs.msg._vehicle_odometry.VehicleOdometry", full_classname_dest, 59) == 0);
  }
  autoware_vehicle_msgs__msg__VehicleOdometry * ros_message = _ros_message;
  {  // stamp
...
PyObject * autoware_vehicle_msgs__msg__vehicle_odometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_vehicle_msgs.msg._vehicle_odometry");
