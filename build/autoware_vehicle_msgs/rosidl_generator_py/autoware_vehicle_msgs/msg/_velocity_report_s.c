...
bool autoware_vehicle_msgs__msg__velocity_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_vehicle_msgs.msg._velocity_report.VelocityReport", full_classname_dest, 57) == 0);
  }
  autoware_vehicle_msgs__msg__VelocityReport * ros_message = _ros_message;
  {  // header
...
PyObject * autoware_vehicle_msgs__msg__velocity_report__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_vehicle_msgs.msg._velocity_report");
