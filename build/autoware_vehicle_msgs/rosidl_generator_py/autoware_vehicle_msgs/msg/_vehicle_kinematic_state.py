    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autoware_vehicle_msgs.msg.VehicleKinematicState')
            logger.debug(
...
class VehicleKinematicState(metaclass=Metaclass_VehicleKinematicState):
    ...
    _fields_and_field_types = {
        ...
        'state': 'autoware_planning_msgs/TrajectoryPoint',
        'delta': 'geometry_msgs/Transform',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'TrajectoryPoint'),  # noqa: E501
