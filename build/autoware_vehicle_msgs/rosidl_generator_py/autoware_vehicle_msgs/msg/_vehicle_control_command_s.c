...
bool autoware_vehicle_msgs__msg__vehicle_control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_vehicle_msgs.msg._vehicle_control_command.VehicleControlCommand", full_classname_dest, 72) == 0);
  }
  autoware_vehicle_msgs__msg__VehicleControlCommand * ros_message = _ros_message;
  {  // stamp
...
PyObject * autoware_vehicle_msgs__msg__vehicle_control_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_vehicle_msgs.msg._vehicle_control_command");
