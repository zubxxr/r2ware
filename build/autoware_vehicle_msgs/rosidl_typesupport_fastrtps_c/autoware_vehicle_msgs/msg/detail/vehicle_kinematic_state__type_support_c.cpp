...
#include "autoware_vehicle_msgs/msg/detail/vehicle_kinematic_state__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_planning_msgs/msg/detail/trajectory_point__functions.h"  // state
...
using _VehicleKinematicState__ros_msg_type = autoware_vehicle_msgs__msg__VehicleKinematicState;
...
size_t get_serialized_size_autoware_vehicle_msgs__msg__VehicleKinematicState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleKinematicState__ros_msg_type * ros_message = static_cast<const _VehicleKinematicState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleKinematicState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__msg__VehicleKinematicState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__msg__VehicleKinematicState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_vehicle_msgs__msg__VehicleKinematicState(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, VehicleKinematicState)() {
