...
#include "autoware_vehicle_msgs/msg/detail/vehicle_control_command__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleControlCommand__ros_msg_type = autoware_vehicle_msgs__msg__VehicleControlCommand;
...
size_t get_serialized_size_autoware_vehicle_msgs__msg__VehicleControlCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleControlCommand__ros_msg_type * ros_message = static_cast<const _VehicleControlCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleControlCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_vehicle_msgs__msg__VehicleControlCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_vehicle_msgs
size_t max_serialized_size_autoware_vehicle_msgs__msg__VehicleControlCommand(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_vehicle_msgs__msg__VehicleControlCommand(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_vehicle_msgs, msg, VehicleControlCommand)() {
