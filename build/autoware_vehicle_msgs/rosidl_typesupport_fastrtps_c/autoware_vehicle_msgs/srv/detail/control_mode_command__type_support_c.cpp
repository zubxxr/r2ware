...
{
  return max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_vehicle_msgs__srv__ControlModeCommand_Response(
    full_bounded, 0);
}
