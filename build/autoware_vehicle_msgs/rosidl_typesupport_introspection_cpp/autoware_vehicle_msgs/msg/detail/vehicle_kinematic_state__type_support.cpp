...
{
  new (message_memory) autoware_vehicle_msgs::msg::VehicleKinematicState(_init);
}

void VehicleKinematicState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_vehicle_msgs::msg::VehicleKinematicState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleKinematicState_message_member_array[3] = {
  {
    ...
    offsetof(autoware_vehicle_msgs::msg::VehicleKinematicState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VehicleKinematicState, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VehicleKinematicState, delta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleKinematicState_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_vehicle_msgs::msg::VehicleKinematicState),
...
get_message_type_support_handle<autoware_vehicle_msgs::msg::VehicleKinematicState>()
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleKinematicState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, VehicleKinematicState)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleKinematicState_message_type_support_handle;
}
