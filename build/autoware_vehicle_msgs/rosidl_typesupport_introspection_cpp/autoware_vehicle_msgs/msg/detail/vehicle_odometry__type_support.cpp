...
{
  new (message_memory) autoware_vehicle_msgs::msg::VehicleOdometry(_init);
}

void VehicleOdometry_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_vehicle_msgs::msg::VehicleOdometry *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleOdometry_message_member_array[4] = {
  {
    ...
    offsetof(autoware_vehicle_msgs::msg::VehicleOdometry, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VehicleOdometry, velocity_mps),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VehicleOdometry, front_wheel_angle_rad),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_vehicle_msgs::msg::VehicleOdometry, rear_wheel_angle_rad),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleOdometry_message_members = {
  ...
  4,  // number of fields
  sizeof(autoware_vehicle_msgs::msg::VehicleOdometry),
...
get_message_type_support_handle<autoware_vehicle_msgs::msg::VehicleOdometry>()
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleOdometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, VehicleOdometry)() {
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_introspection_cpp::VehicleOdometry_message_type_support_handle;
}
