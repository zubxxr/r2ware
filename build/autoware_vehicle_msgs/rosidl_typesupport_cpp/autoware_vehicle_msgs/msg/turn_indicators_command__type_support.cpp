...
static const _TurnIndicatorsCommand_type_support_symbol_names_t _TurnIndicatorsCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)),
  }
};
...
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_cpp::TurnIndicatorsCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_vehicle_msgs, msg, TurnIndicatorsCommand)() {
  return get_message_type_support_handle<autoware_vehicle_msgs::msg::TurnIndicatorsCommand>();
}
