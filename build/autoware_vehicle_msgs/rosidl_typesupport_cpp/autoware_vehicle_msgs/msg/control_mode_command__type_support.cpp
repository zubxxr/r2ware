...
static const _ControlModeCommand_type_support_symbol_names_t _ControlModeCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_vehicle_msgs, msg, ControlModeCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_vehicle_msgs, msg, ControlModeCommand)),
  }
};
...
{
  return &::autoware_vehicle_msgs::msg::rosidl_typesupport_cpp::ControlModeCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_vehicle_msgs, msg, ControlModeCommand)() {
  return get_message_type_support_handle<autoware_vehicle_msgs::msg::ControlModeCommand>();
}
