...
#ifndef TIER4_PLANNING_MSGS__SRV__DETAIL__SET_LANELET_ROUTE__FUNCTIONS_H_
#define TIER4_PLANNING_MSGS__SRV__DETAIL__SET_LANELET_ROUTE__FUNCTIONS_H_
 ...
 * calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Request__init().
...
/**
 * It calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Request__fini()
 ...
 * tier4_planning_msgs__srv__SetLaneletRoute_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_planning_msgs
...
/**
 * It calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_planning_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_planning_msgs
...
/**
 * It calls
 * tier4_planning_msgs__srv__SetLaneletRoute_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_PLANNING_MSGS__SRV__DETAIL__SET_LANELET_ROUTE__FUNCTIONS_H_
