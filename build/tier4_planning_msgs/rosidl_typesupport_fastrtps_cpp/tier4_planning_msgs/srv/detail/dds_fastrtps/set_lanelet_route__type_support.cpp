...
#include "tier4_planning_msgs/srv/detail/set_lanelet_route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::srv::SetLaneletRoute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::srv::SetLaneletRoute_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_SetLaneletRoute_Request(full_bounded, 0);
}
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_SetLaneletRoute_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::srv::SetLaneletRoute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::srv::SetLaneletRoute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_SetLaneletRoute_Response(full_bounded, 0);
}
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_SetLaneletRoute_Response__handle;
}
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_SetLaneletRoute__handle;
}
