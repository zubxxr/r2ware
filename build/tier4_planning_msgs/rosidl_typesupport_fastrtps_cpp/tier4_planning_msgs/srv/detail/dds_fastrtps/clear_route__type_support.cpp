...
#include "tier4_planning_msgs/srv/detail/clear_route__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_planning_msgs::srv::ClearRoute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_planning_msgs::srv::ClearRoute_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::srv::ClearRoute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::srv::ClearRoute_Request *>(
    untyped_ros_message);
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_planning_msgs, srv, ClearRoute_Request)() {
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tier4_planning_msgs
cdr_serialize(
  const tier4_planning_msgs::srv::ClearRoute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_planning_msgs::srv::ClearRoute_Response & ros_message)
{
  // Member: status
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::srv::ClearRoute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::srv::ClearRoute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_planning_msgs, srv, ClearRoute_Response)() {
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute_Response__handle;
}
...
{
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_planning_msgs, srv, ClearRoute)() {
  return &tier4_planning_msgs::srv::typesupport_fastrtps_cpp::_ClearRoute__handle;
}
