...
static const _ClearRoute_Request_type_support_symbol_names_t _ClearRoute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, srv, ClearRoute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, srv, ClearRoute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_planning_msgs, srv, ClearRoute_Request)() {
  return &::tier4_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_Request_message_type_support_handle;
}
...
static const _ClearRoute_Response_type_support_symbol_names_t _ClearRoute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, srv, ClearRoute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, srv, ClearRoute_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tier4_planning_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_planning_msgs, srv, ClearRoute_Response)() {
  return &::tier4_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_Response_message_type_support_handle;
}
...
static const _ClearRoute_type_support_symbol_names_t _ClearRoute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, srv, ClearRoute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, srv, ClearRoute)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tier4_planning_msgs, srv, ClearRoute)() {
  return &::tier4_planning_msgs::srv::rosidl_typesupport_c::ClearRoute_service_type_support_handle;
}
