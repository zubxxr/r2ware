...
#include "tier4_planning_msgs/msg/detail/route_state__rosidl_typesupport_fastrtps_c.h"
...
using _RouteState__ros_msg_type = tier4_planning_msgs__msg__RouteState;
...
size_t get_serialized_size_tier4_planning_msgs__msg__RouteState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RouteState__ros_msg_type * ros_message = static_cast<const _RouteState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RouteState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_planning_msgs__msg__RouteState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_planning_msgs
size_t max_serialized_size_tier4_planning_msgs__msg__RouteState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tier4_planning_msgs__msg__RouteState(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, msg, RouteState)() {
