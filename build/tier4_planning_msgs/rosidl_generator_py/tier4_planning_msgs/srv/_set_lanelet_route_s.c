...
bool tier4_planning_msgs__srv__set_lanelet_route__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_planning_msgs.srv._set_lanelet_route.SetLaneletRoute_Request", full_classname_dest, 66) == 0);
  }
  tier4_planning_msgs__srv__SetLaneletRoute_Request * ros_message = _ros_message;
  {  // header
...
PyObject * tier4_planning_msgs__srv__set_lanelet_route__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_planning_msgs.srv._set_lanelet_route");
...
ROSIDL_GENERATOR_C_EXPORT
bool tier4_planning_msgs__srv__set_lanelet_route__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_planning_msgs.srv._set_lanelet_route.SetLaneletRoute_Response", full_classname_dest, 67) == 0);
  }
  tier4_planning_msgs__srv__SetLaneletRoute_Response * ros_message = _ros_message;
  {  // status
