...
class Metaclass_ClearRoute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tier4_planning_msgs.srv import _clear_route
...
class ClearRoute(metaclass=Metaclass_ClearRoute):
    from tier4_planning_msgs.srv._clear_route import ClearRoute_Request as Request
    from tier4_planning_msgs.srv._clear_route import ClearRoute_Response as Response
