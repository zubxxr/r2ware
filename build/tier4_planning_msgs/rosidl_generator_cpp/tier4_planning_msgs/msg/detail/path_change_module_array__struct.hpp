...
struct PathChangeModuleArray_
{
  ...
  _header_type header;
  using _modules_type =
    std::vector<tier4_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>>::other>;
  ...
  Type & set__modules(
    const std::vector<tier4_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>>::other> & _arg)
  {
    this->modules = _arg;
    return *this;
  }
