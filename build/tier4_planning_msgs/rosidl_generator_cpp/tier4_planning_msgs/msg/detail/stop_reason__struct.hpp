...
struct StopReason_
{
  ...
  using _stop_factors_type =
    std::vector<tier4_planning_msgs::msg::StopFactor_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::StopFactor_<ContainerAllocator>>::other>;
  ...
  Type & set__stop_factors(
    const std::vector<tier4_planning_msgs::msg::StopFactor_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::StopFactor_<ContainerAllocator>>::other> & _arg)
  {
  ...
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> OUT_OF_LANE;
  ...
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> AVOIDANCE_BY_LANE_CHANGE;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> EXTERNAL_LANE_CHANGE;
