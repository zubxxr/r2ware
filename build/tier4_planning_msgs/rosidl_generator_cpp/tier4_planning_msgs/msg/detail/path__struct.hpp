...
struct Path_
{
  ...
  _header_type header;
  using _points_type =
    std::vector<tier4_planning_msgs::msg::PathPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::PathPoint_<ContainerAllocator>>::other>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<tier4_planning_msgs::msg::PathPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::PathPoint_<ContainerAllocator>>::other> & _arg)
  {
    this->points = _arg;
    return *this;
  }
