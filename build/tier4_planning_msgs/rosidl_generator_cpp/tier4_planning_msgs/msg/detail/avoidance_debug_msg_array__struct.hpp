...
struct AvoidanceDebugMsgArray_
{
  ...
  using _avoidance_info_type =
    std::vector<tier4_planning_msgs::msg::AvoidanceDebugMsg_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::AvoidanceDebugMsg_<ContainerAllocator>>::other>;
  ...
  Type & set__avoidance_info(
    const std::vector<tier4_planning_msgs::msg::AvoidanceDebugMsg_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::AvoidanceDebugMsg_<ContainerAllocator>>::other> & _arg)
  {
