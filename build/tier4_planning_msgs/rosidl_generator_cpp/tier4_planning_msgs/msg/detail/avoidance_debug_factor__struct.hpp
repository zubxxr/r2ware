...
struct AvoidanceDebugFactor_
{
  ...
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> OBJECT_IS_NOT_TYPE;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> OBJECT_IS_BEHIND_THRESHOLD;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> OBJECT_IS_IN_FRONT_THRESHOLD;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> OBJECT_BEHIND_PATH_GOAL;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> NOT_PARKING_OBJECT;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> MOVING_OBJECT;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> SAME_DIRECTION_SHIFT;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> TOO_NEAR_TO_CENTERLINE;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> INSUFFICIENT_LATERAL_MARGIN;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> REMAINING_DISTANCE_LESS_THAN_ZERO;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> TOO_LARGE_JERK;
