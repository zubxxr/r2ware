...
struct StopReasonArray_
{
  ...
  using _stop_reasons_type =
    std::vector<tier4_planning_msgs::msg::StopReason_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::StopReason_<ContainerAllocator>>::other>;
  ...
  Type & set__stop_reasons(
    const std::vector<tier4_planning_msgs::msg::StopReason_<ContainerAllocator>, typename ContainerAllocator::template rebind<tier4_planning_msgs::msg::StopReason_<ContainerAllocator>>::other> & _arg)
  {
