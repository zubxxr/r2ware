...
#include <stddef.h>
#include "tier4_planning_msgs/msg/detail/route_state__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tier4_planning_msgs__msg__RouteState__init(message_memory);
}

void RouteState__rosidl_typesupport_introspection_c__RouteState_fini_function(void * message_memory)
{
  tier4_planning_msgs__msg__RouteState__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember RouteState__rosidl_typesupport_introspection_c__RouteState_message_member_array[2] = {
  {
    ...
    offsetof(tier4_planning_msgs__msg__RouteState, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_planning_msgs__msg__RouteState, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers RouteState__rosidl_typesupport_introspection_c__RouteState_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_planning_msgs__msg__RouteState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, RouteState)() {
