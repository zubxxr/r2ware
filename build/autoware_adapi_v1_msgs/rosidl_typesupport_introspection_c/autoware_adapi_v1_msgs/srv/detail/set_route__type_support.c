...
static rosidl_typesupport_introspection_c__MessageMember SetRoute_Request__rosidl_typesupport_introspection_c__SetRoute_Request_message_member_array[4] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__srv__SetRoute_Request, option),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetRoute_Request)() {
  ...
  SetRoute_Request__rosidl_typesupport_introspection_c__SetRoute_Request_message_member_array[3].members_ =
