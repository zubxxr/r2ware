...
size_t SteeringFactor__rosidl_typesupport_introspection_c__size_function__CooperationStatus__cooperation(
  const void * untyped_member)
{
...
const void * SteeringFactor__rosidl_typesupport_introspection_c__get_const_function__CooperationStatus__cooperation(
  const void * untyped_member, size_t index)
{
  const autoware_adapi_v1_msgs__msg__CooperationStatus__Sequence * member =
    (const autoware_adapi_v1_msgs__msg__CooperationStatus__Sequence *)(untyped_member);
...
void * SteeringFactor__rosidl_typesupport_introspection_c__get_function__CooperationStatus__cooperation(
  void * untyped_member, size_t index)
{
...
bool SteeringFactor__rosidl_typesupport_introspection_c__resize_function__CooperationStatus__cooperation(
...
static rosidl_typesupport_introspection_c__MessageMember SteeringFactor__rosidl_typesupport_introspection_c__SteeringFactor_message_member_array[9] = {
  {
    "pose",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    SteeringFactor__rosidl_typesupport_introspection_c__size_function__CooperationStatus__cooperation,  // size() function pointer
    SteeringFactor__rosidl_typesupport_introspection_c__get_const_function__CooperationStatus__cooperation,  // get_const(index) function pointer
    SteeringFactor__rosidl_typesupport_introspection_c__get_function__CooperationStatus__cooperation,  // get(index) function pointer
    SteeringFactor__rosidl_typesupport_introspection_c__resize_function__CooperationStatus__cooperation  // resize(index) function pointer
  },
  {
    "type",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_UINT16,  // type
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, msg, SteeringFactor)() {
  ...
  SteeringFactor__rosidl_typesupport_introspection_c__SteeringFactor_message_member_array[7].members_ =
