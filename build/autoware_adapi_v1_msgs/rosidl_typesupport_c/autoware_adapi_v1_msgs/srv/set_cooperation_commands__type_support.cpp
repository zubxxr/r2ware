...
static const _SetCooperationCommands_Request_type_support_symbol_names_t _SetCooperationCommands_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Request)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetCooperationCommands_Request_message_type_support_handle;
}
...
static const _SetCooperationCommands_Response_type_support_symbol_names_t _SetCooperationCommands_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_adapi_v1_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands_Response)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetCooperationCommands_Response_message_type_support_handle;
}
...
static const _SetCooperationCommands_type_support_symbol_names_t _SetCooperationCommands_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SetCooperationCommands)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SetCooperationCommands_service_type_support_handle;
}
