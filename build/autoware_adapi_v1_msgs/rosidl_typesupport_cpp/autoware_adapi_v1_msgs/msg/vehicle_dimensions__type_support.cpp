...
static const _VehicleDimensions_type_support_symbol_names_t _VehicleDimensions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_adapi_v1_msgs, msg, VehicleDimensions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, VehicleDimensions)),
  }
};
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_cpp::VehicleDimensions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_adapi_v1_msgs, msg, VehicleDimensions)() {
  return get_message_type_support_handle<autoware_adapi_v1_msgs::msg::VehicleDimensions>();
}
