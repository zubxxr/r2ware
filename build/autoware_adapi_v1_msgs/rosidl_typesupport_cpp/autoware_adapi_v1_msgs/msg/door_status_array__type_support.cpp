...
static const _DoorStatusArray_type_support_symbol_names_t _DoorStatusArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_adapi_v1_msgs, msg, DoorStatusArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, DoorStatusArray)),
  }
};
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_cpp::DoorStatusArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_adapi_v1_msgs, msg, DoorStatusArray)() {
  return get_message_type_support_handle<autoware_adapi_v1_msgs::msg::DoorStatusArray>();
}
