...
static const _DynamicObject_type_support_symbol_names_t _DynamicObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_adapi_v1_msgs, msg, DynamicObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, DynamicObject)),
  }
};
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_cpp::DynamicObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_adapi_v1_msgs, msg, DynamicObject)() {
  return get_message_type_support_handle<autoware_adapi_v1_msgs::msg::DynamicObject>();
}
