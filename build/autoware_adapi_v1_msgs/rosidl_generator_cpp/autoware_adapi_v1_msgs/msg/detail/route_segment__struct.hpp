...
struct RouteSegment_
{
  ...
  using _alternatives_type =
    std::vector<autoware_adapi_v1_msgs::msg::RoutePrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RoutePrimitive_<ContainerAllocator>>::other>;
  ...
  Type & set__alternatives(
    const std::vector<autoware_adapi_v1_msgs::msg::RoutePrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RoutePrimitive_<ContainerAllocator>>::other> & _arg)
  {
