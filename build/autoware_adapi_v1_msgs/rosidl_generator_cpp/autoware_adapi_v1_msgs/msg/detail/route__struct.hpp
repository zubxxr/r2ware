...
struct Route_
{
  ...
  _header_type header;
  using _data_type =
    rosidl_runtime_cpp::BoundedVector<autoware_adapi_v1_msgs::msg::RouteData_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RouteData_<ContainerAllocator>>::other>;
  _data_type data;
  ...
  Type & set__data(
    const rosidl_runtime_cpp::BoundedVector<autoware_adapi_v1_msgs::msg::RouteData_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RouteData_<ContainerAllocator>>::other> & _arg)
  {
    this->data = _arg;
    return *this;
  }
