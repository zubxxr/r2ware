...
struct VelocityFactorArray_
{
  ...
  _header_type header;
  using _factors_type =
    std::vector<autoware_adapi_v1_msgs::msg::VelocityFactor_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::VelocityFactor_<ContainerAllocator>>::other>;
  ...
  Type & set__factors(
    const std::vector<autoware_adapi_v1_msgs::msg::VelocityFactor_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::VelocityFactor_<ContainerAllocator>>::other> & _arg)
  {
    this->factors = _arg;
    return *this;
  }
