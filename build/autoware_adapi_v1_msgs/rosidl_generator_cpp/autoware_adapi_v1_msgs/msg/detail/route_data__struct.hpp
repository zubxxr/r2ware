...
struct RouteData_
{
  ...
  using _segments_type =
    std::vector<autoware_adapi_v1_msgs::msg::RouteSegment_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RouteSegment_<ContainerAllocator>>::other>;
  ...
  Type & set__segments(
    const std::vector<autoware_adapi_v1_msgs::msg::RouteSegment_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_adapi_v1_msgs::msg::RouteSegment_<ContainerAllocator>>::other> & _arg)
  {
    this->segments = _arg;
    return *this;
  }
