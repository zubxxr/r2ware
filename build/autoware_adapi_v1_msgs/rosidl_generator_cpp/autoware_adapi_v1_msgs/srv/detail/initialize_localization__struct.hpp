...
struct InitializeLocalization_Request_
{
  ...
  using _pose_type =
    rosidl_runtime_cpp::BoundedVector<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>::other>;
  _pose_type pose;

  // setters for named parameter idiom
  Type & set__pose(
    const rosidl_runtime_cpp::BoundedVector<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<geometry_msgs::msg::PoseWithCovarianceStamped_<ContainerAllocator>>::other> & _arg)
  {
    this->pose = _arg;
    return *this;
  }
