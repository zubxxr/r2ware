...
bool autoware_adapi_v1_msgs__msg__dynamic_object_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._dynamic_object_path.DynamicObjectPath", full_classname_dest, 65) == 0);
  }
  autoware_adapi_v1_msgs__msg__DynamicObjectPath * ros_message = _ros_message;
  {  // path
...
{
  /* NOTE(esteve): Call constructor of DynamicObjectPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._dynamic_object_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamicObjectPath");
