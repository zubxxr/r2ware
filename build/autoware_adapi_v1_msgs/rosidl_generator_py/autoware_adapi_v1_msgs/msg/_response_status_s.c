...
bool autoware_adapi_v1_msgs__msg__response_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._response_status.ResponseStatus", full_classname_dest, 58) == 0);
  }
  autoware_adapi_v1_msgs__msg__ResponseStatus * ros_message = _ros_message;
  {  // success
...
PyObject * autoware_adapi_v1_msgs__msg__response_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._response_status");
