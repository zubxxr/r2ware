...
{
  new (message_memory) autoware_adapi_v1_msgs::msg::ObjectClassification(_init);
}

void ObjectClassification_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_adapi_v1_msgs::msg::ObjectClassification *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectClassification_message_member_array[2] = {
  {
    ...
    offsetof(autoware_adapi_v1_msgs::msg::ObjectClassification, label),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs::msg::ObjectClassification, probability),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectClassification_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_adapi_v1_msgs::msg::ObjectClassification),
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectClassification_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, ObjectClassification)() {
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectClassification_message_type_support_handle;
}
