...
{
  new (message_memory) autoware_adapi_v1_msgs::msg::DynamicObjectArray(_init);
}

void DynamicObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_adapi_v1_msgs::msg::DynamicObjectArray *>(message_memory);
  typed_message->~DynamicObjectArray();
}

size_t size_function__DynamicObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_adapi_v1_msgs::msg::DynamicObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_adapi_v1_msgs::msg::DynamicObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_adapi_v1_msgs::msg::DynamicObject> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DynamicObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(autoware_adapi_v1_msgs::msg::DynamicObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_adapi_v1_msgs::msg::DynamicObject>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs::msg::DynamicObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DynamicObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_adapi_v1_msgs::msg::DynamicObjectArray),
...
{
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::DynamicObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_adapi_v1_msgs, msg, DynamicObjectArray)() {
  return &::autoware_adapi_v1_msgs::msg::rosidl_typesupport_introspection_cpp::DynamicObjectArray_message_type_support_handle;
}
