...
#include "autoware_adapi_v1_msgs/msg/detail/route_option__rosidl_typesupport_fastrtps_c.h"
...
using _RouteOption__ros_msg_type = autoware_adapi_v1_msgs__msg__RouteOption;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RouteOption__ros_msg_type * ros_message = static_cast<const _RouteOption__ros_msg_type *>(untyped_ros_message);
  // Field name: allow_goal_modification
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RouteOption__ros_msg_type * ros_message = static_cast<_RouteOption__ros_msg_type *>(untyped_ros_message);
  // Field name: allow_goal_modification
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _RouteOption__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__msg__RouteOption(
...
static size_t _RouteOption__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_adapi_v1_msgs__msg__RouteOption(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_RouteOption = {
...
static rosidl_message_type_support_t _RouteOption__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RouteOption,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, msg, RouteOption)() {
  return &_RouteOption__type_support;
}
