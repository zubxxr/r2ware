...
#include "autoware_adapi_v1_msgs/msg/detail/object_classification__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectClassification__ros_msg_type = autoware_adapi_v1_msgs__msg__ObjectClassification;
...
static uint32_t _ObjectClassification__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__msg__ObjectClassification(
...
{
  return max_serialized_size_autoware_adapi_v1_msgs__msg__ObjectClassification(
    full_bounded, 0);
}
