...
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__SetCooperationCommands_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_adapi_v1_msgs__srv__SetCooperationCommands_Response(
    full_bounded, 0);
}
