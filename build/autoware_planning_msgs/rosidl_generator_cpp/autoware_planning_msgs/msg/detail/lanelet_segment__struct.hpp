...
struct LaneletSegment_
{
  ...
  using _primitives_type =
    std::vector<autoware_planning_msgs::msg::LaneletPrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_planning_msgs::msg::LaneletPrimitive_<ContainerAllocator>>::other>;
  ...
  Type & set__primitives(
    const std::vector<autoware_planning_msgs::msg::LaneletPrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_planning_msgs::msg::LaneletPrimitive_<ContainerAllocator>>::other> & _arg)
  {
